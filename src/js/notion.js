// ========================================
// NOTION.JS — API fetch calls and data transformation
// ========================================
// Fetches content from the server API endpoints (which pull from Notion).
// Falls back gracefully if any endpoint fails.

// SVG Icons for Social Platforms
// Used in both the sidebar and contact section.
const SOCIAL_ICONS = {
